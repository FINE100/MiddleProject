					...
					<div class="card-body" style="padding: 0px -150px">
						...
						<div class="row">
							<div class="card-body">
								...
								name="memberId" value="${id }" readonly="readonly"
										style="width: 250px; margin-botton: 50px;">
								</div>
								...
								<div class="card-body">
									<div class="mb-3" style="margin-top: -60px; width: 645px">
										...
										<textarea rows="text" class="form-control" rows="50"
											placeholder="자유롭게 후기를 남겨주세요!" name="reviewContent" id ="reviewContent"></textarea>
									</div>
									<!-- 점수 -->
									<div class="row">
										<div class="col-lg-6">
											<div class="mb-3">
												<label class="form-label">Score</label> <select name="reviewScore"
												id="reviewScore"
													class="select2 form-control select2-hidden-accessible"
													data-select2-placeholder="Select country"
													data-select2-id="select2-data-1-gy14" tabindex="-1"
													aria-hidden="true" style="width: 645px">
													<option data-select2-id="select2-data-3-ibs9"></option>
													<option value="★★★★★">★★★★★</option>
													<option value="★★★★">★★★★</option>
													<option value="★★★">★★★</option>
									...
									<h3 class="h6">Img</h3>
									<input class="form-control" type="file" name="ufile"
										style="width: 645px">
					...
					<div>
						<p>
							<button class="btn btn-primary btn-sm btn-icon-text"
								type="submit" onclick="location.href='reviewInsert.do'">
								<i class="bi bi-save"></i><span class="text">Write</span>
							</button>
							<button class="btn btn-light btn-sm btn-icon-text" type="reset"
