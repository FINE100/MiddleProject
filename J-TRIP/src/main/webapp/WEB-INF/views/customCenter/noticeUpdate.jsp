...
<body>
	<div class="comment-form-wrap pt-5" style="margin-top: 100px;  padding-right:120px; padding-left:120px;">
		...
		<h6 style="text-align: center; margin-top: -20px">공지사항에 대해
			안내드립니다.</h6>
		<br>
		<form id="frm" action="noticeUpdate.do" class="p-5 bg-light"
			method="post">
			...
			<div class="form-group">
				...
				<textarea cols="30" rows="10" class="form-control"
					id="noticeContent" name="noticeContent">${vo.noticeContent}</textarea>
			</div>
		...
		<form id="frm1" action="noticeDelete.do" method="post">
			<input type="hidden" id="notictNo1" name="noticeNo1"
				value="${vo.noticeNo}">
			<button type="submit" class="btn btn-outline-dark"
