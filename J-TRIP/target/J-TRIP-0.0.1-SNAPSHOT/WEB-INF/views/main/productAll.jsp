      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
          <div class="col-md-9 ftco-animate pb-4">
            <h1 class="mb-3 bread">새로운 장소를 찾아볼까요?</h1>
    				...
    				<div class="row">
		    			<div class="col-md-6 col-lg-4 ftco-animate">
		    				<div class="project">
			    				...
			    				<div class="text">
			    					<h4 class="price"><span class="old-price mr-2">100만원</span>60만원</h4>
			    					<span>2022.09.22~ 2022.09.30</span>
			    					<h3><a href="productSingle.do">경주</a></h3>
		    			...
		    			<div class="col-md-6 col-lg-4 ftco-animate">
		    				<div class="project">
			    				...
			    				<div class="text">
			    					...
			    					<h3><a href="productSingle.do">여행가고싶네여...</a></h3>
			    					<div class="star d-flex clearfix">
			    						<div class="mr-auto float-left">
				    						<span class="ion-ios-star"></span>
				    						<span class="ion-ios-star"></span>
		    			...
		    			<div class="col-md-6 col-lg-4 ftco-animate">
		    				<div class="project">
		    					<div class="img">
				    				<a href="productSingle.do"><img src="images/destination-6.jpg" class="img-fluid" alt="Colorlib Template"></a>
			    				</div>
			    				<div class="text">
			    					<h4 class="price">40만원</h4>
			    					<span>15 Days Tour</span>
			    					<h3><a href="productSingle.do">별빛 강릉 여행</a></h3>
			    					<div class="star d-flex clearfix">
			    						<div class="mr-auto float-left">
				    						<span class="ion-ios-star"></span>
				    						<span class="ion-ios-star"></span>
